...
import "./EditUser.css"; // reuse same styles
...
export default function EditCustomer() {
  ...
  const [formData, setFormData] = useState({
    ...
    status: customer?.status === "ACTIVE" ? "Active" : "Inactive", // Handle the pre-fill properly
  });
  ...
  const handleUpdate = async (e) => {
    ...
    const payload = {
      ...
      emailId: formData.emailId, // backend identifies by email
